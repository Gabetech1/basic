...
<html lang="en" dir="ltr">
  ...
  <title>Gabe - Admin Dashboard</title>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block">Gabriel Abiah</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2021</span> Copyright Gabes Dashboard Bootstrap Template by
                <a
                  class="text-primary"
                  href="http://www.gabeshub.com/"
                  target="_blank"
                  >Gabe</a
                >.
              </p>
